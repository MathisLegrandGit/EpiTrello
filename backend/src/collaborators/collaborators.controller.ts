...
export class CollaboratorsController {
    ...
    async respondToInvitation(
        ...
        return this.collaboratorsService.respondToInvitation(boardId, body.userId, body.accept);
    }
    ...
    async removeCollaborator(
        ...
        await this.collaboratorsService.removeCollaborator(boardId, userId, body.requesterId);
    }
