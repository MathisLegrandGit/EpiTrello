...
<template>
    ...
    <div v-if="isAdding" :class="isDarkMode ? 'bg-slate-800/50 border-slate-700/50' : 'bg-white/60 border-slate-200/60'"
        class="rounded-2xl p-5 border shadow-sm min-w-[320px] flex-shrink-0 animate-scale-in">
    ...
    <button v-else @click="startAdding"
        ...
        class="min-w-[320px] flex-shrink-0 p-5 rounded-2xl border-2 border-dashed flex items-center justify-center gap-3 transition-all duration-300 hover:shadow-md group">
