...
export function useBoard() {
    ...
    async function updateCard(cardId: string, updates: { title?: string; description?: string; label_ids?: string[]; member_ids?: string[]; list_id?: string; position?: number; due_date?: string | null }) {
        try {
